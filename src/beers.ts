...
export const beers: Beer[] = [
  ...
  { brand: "Antikorpo Brewing", country: "Italia", regione: "Friuli-Venezia Giulia", flag: "IT", rarity: "rara", desc: "Craft brewery giuliana sfrontata ed indipendente di Sgonico (Trieste).", variants: ["Low Rider", "Bikini Atoll", "Sunburn"], barcodes: [] },
  ...
  { brand: "Birra 100Venti", country: "Italia", regione: "Piemonte", flag: "IT", rarity: "media", desc: "Birrificio artigianale piemontese di Borgomanero.", variants: ["James Blonde", "Rumble", "Tribe"], barcodes: [] },
  { brand: "Birra Bellazzi", country: "Italia", regione: "Emilia-Romagna", flag: "IT", rarity: "media", desc: "Birrificio bolognese creativo e non convenzionale con sede a San Lazzaro di Savena.", variants: ["My Antonia", "Jalapeño", "Calle"], barcodes: [] },
  { brand: "Birra Del Bosco", country: "Italia", regione: "Trentino-Alto Adige", flag: "IT", rarity: "media", desc: "Microbirrificio artigianale trentino immerso nella natura a San Michele all'Adige.", variants: ["Froggy Hop", "Pale Ale", "Stout"], barcodes: [] },
  { brand: "Birra Elvo", country: "Italia", regione: "Piemonte", flag: "IT", rarity: "media", desc: "Birrificio artigianale piemontese rinomato per le sue eccezionali Lager tradizionali in stile tedesco.", variants: ["Pils", "Garanzia", "Schwarz", "Doppelbock"], barcodes: [] },
  { brand: "Birrificio Italiano", country: "Italia", regione: "Lombardia", flag: "IT", rarity: "rara", desc: "Storico birrificio artigianale lombardo.", variants: ["Tipopils", "Bibock", "Nigredo", "Vudù", "Amber Shock", "I'M (Klanbarrique)"], barcodes: [] },
  { brand: "Birrificio Lambrate", country: "Italia", regione: "Lombardia", flag: "IT", rarity: "rara", desc: "Il birrificio simbolo di Milano e del fermento artigianale.", variants: ["Montestella", "Sant'Ambroeus", "Ghisa", "Porpora", "Quarantot", "Navili"], barcodes: [] },
  ...
  { brand: "Birrificio Monpiër", country: "Italia", regione: "Trentino-Alto Adige", flag: "IT", rarity: "media", desc: "Birrificio artigianale delle Dolomiti in Val Gardena (Ortisei).", variants: ["Pale Ale", "Weiss", "IPA"], barcodes: [] },
  { brand: "Birrificio Noiz", country: "Italia", regione: "Lombardia", flag: "IT", rarity: "media", desc: "Microbirrificio artigianale bresciano moderno focalizzato su luppolature fresche ed intense.", variants: ["Noiz Hazy IPA", "Session IPA", "Pils"], barcodes: [] },
  { brand: "Birra Perugia", country: "Italia", regione: "Umbria", flag: "IT", rarity: "media", desc: "Storico marchio umbro (1875) rinato come birrificio artigianale pluri-premiato.", variants: ["Calibro 7", "Santa ILA", "Mario tra 20 anni", "Barley Wine"], barcodes: [] },
  { brand: "Birrificio 61cento", country: "Italia", regione: "Marche", flag: "IT", rarity: "media", desc: "Primo birrificio artigianale cooperativo delle Marche, nato a Pesaro.", variants: ["Elia", "La 100", "Koperniko"], barcodes: [] },
  { brand: "Birrificio Civale", country: "Italia", regione: "Piemonte", flag: "IT", rarity: "media", desc: "Eccellenza brassicola alessandrina vincitrice di numerosi riconoscimenti.", variants: ["Moonrise", "Maledetta", "Ulula", "Impetus"], barcodes: [] },
  ...
  { brand: "Brewski", country: "Svezia", flag: "SE", rarity: "rara", desc: "Pioniere svedese delle Fruit IPA e Craft Beer sfrontate ed aromatiche.", variants: ["Mangofeber", "Passionfeber", "Barbarian IPA"], barcodes: [] },
  ...
  { brand: "Ca' del Brado", country: "Italia", regione: "Emilia-Romagna", flag: "IT", rarity: "rara", desc: "Bottega brassicola emiliana specializzata in fermentazioni selvatiche, lieviti indigeni ed affinamento in botte.", variants: ["U Baccarossa", "Nessun Dorma", "Piè Veloce"], barcodes: [] },
  ...
  { brand: "Fantôme", country: "Belgio", flag: "BE", rarity: "rara", desc: "Leggendario birrificio artigianale della Vallonia famoso nel mondo per le sue Saison complesse e misteriose.", variants: ["Fantome Saison", "Pisse-Debout"], barcodes: [] },
  ...
  { brand: "Jungle Juice Brewing", country: "Italia", regione: "Lazio", flag: "IT", rarity: "media", desc: "Birrificio indipendente di Roma celebrato per le sue IPA luppolate ed Hazy succose.", variants: ["Hammersmith Calling", "Zauberziege", "Jungle Shake"], barcodes: [] },
  { brand: "Kashmir", country: "Italia", regione: "Molise", flag: "IT", rarity: "media", desc: "Microbirrificio artigianale molisano attento alla freschezza ed alla bevibilità.", variants: ["432 HZ", "Lamortesua", "Lamortesua Holiday"], barcodes: [] },
  { brand: "La Casa di Cura", country: "Italia", regione: "Abruzzo", flag: "IT", rarity: "media", desc: "Originale birrificio artigianale abruzzese di Crognaleto (Teramo) dalle ricette curative per lo spirito.", variants: ["TSE", "Placebo", "Terapia di Gruppo"], barcodes: [] },
  ...
  { brand: "LoverBeer", country: "Italia", regione: "Piemonte", flag: "IT", rarity: "rara", desc: "Leggendario birrificio piemontese di Marentino celebrato nel mondo per le sue fermentazioni selvatiche e birre con uva.", variants: ["BeerBera", "D'UvaBeer", "Nebulin-a", "Sogno d'April"], barcodes: [] },
  ...
  { brand: "Mister B", country: "Italia", regione: "Lombardia", flag: "IT", rarity: "media", desc: "Birrificio mantovano noto per le sue lattine eccentriche e le ricette ricche di luppolo.", variants: ["B.A.G.A.", "Bamba", "B.A.B.O."], barcodes: [] },
  ...
  { brand: "Ofelia", country: "Italia", regione: "Veneto", flag: "IT", rarity: "media", desc: "Birrificio artigianale vicentino di Sovizzo famoso per l'equilibrio e l'eleganza aromatica.", variants: ["Amitrano", "Piazza delle Erbe", "Nostress"], barcodes: [] },
  ...
  { brand: "Retorto", country: "Italia", regione: "Emilia-Romagna", flag: "IT", rarity: "rara", desc: "Birrificio emiliano di Podenzano (Piacenza) rinomato per birre di carattere irriverente e stili robusti.", variants: ["Maladeta", "Morning Glory", "Krakatoa", "Blackness"], barcodes: [] },
  ...
  { brand: "Ritual Lab", country: "Italia", regione: "Lazio", flag: "IT", rarity: "rara", desc: "Birrificio di Formello vincitore di plurimi premi come Birraio dell'Anno per la qualità delle sue IPA e Imperial Stout.", variants: ["Tupamaros", "Papanero French Whisky", "Super Santos", "Papanero Phantom Spirits"], barcodes: [] },
  ...
  { brand: "Samuel Smith", country: "Regno Unito", flag: "GB", rarity: "media", desc: "Il più antico birrificio dello Yorkshire (1758), famoso per la fermentazione nelle tradizionali vasche in pietra (Yorkshire Squares).", variants: ["Imperial Stout", "Nut Brown Ale", "Oatmeal Stout", "Taddy Porter"], barcodes: [] },
  { brand: "Shire Brewing", country: "Italia", regione: "Lazio", flag: "IT", rarity: "rara", desc: "Birrificio artigianale specializzato in Real Ale, Cask Beer e basse fermentazioni ad altissima bevibilità.", variants: ["Fur Elise", "J.Cook", "Raus Giovenca"], barcodes: [] },
  { brand: "Siemàn", country: "Italia", regione: "Veneto", flag: "IT", rarity: "rara", desc: "Azienda agricola e birrificio dei Colli Berici (Vicenza) dedicato all'incontro tra birra artigianale, uva ed affinamento in botte.", variants: ["Camaleonte", "Istinto", "Occhio al Frutto"], barcodes: [] },
  ...
  { brand: "Wild Raccoon", country: "Italia", regione: "Friuli-Venezia Giulia", flag: "IT", rarity: "rara", desc: "Craft brewery friulana famosa per le sue Stout golose e produzioni in edizioni limitatissime.", variants: ["16mm Amburana & Vanilla", "16mm Mexican Chocolate"], barcodes: [] },
...
export const countryCoordinates: Record<string, { latMin: number; latMax: number; lngMin: number; lngMax: number }> = {
  ...
  "Svezia": { latMin: 55.3, latMax: 69.1, lngMin: 11.1, lngMax: 24.2 }
};
